      ...
      <aside className={`fixed inset-y-0 left-0 z-30 w-64 bg-surface-card border-r border-surface-border flex flex-col transform transition-transform duration-300 lg:translate-x-0 lg:inset-auto lg:sticky lg:top-0 lg:h-screen ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="px-4 py-4 border-b border-surface-border">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-brand-600/20 border border-brand-600/30 flex items-center justify-center text-brand-700 font-display font-bold text-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button onClick={() => setNotifOpen(!notifOpen)}
                className="relative p-2 text-ink-muted hover:text-ink hover:bg-surface-hover rounded-xl transition-colors">
